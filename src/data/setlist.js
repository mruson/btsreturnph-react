...
export const setlist = [
  ...
  },
  {
    ...
    lyrics: [
      { t: 4, text: '[[Kim Namjoon! Kim Seokjin! Min Yoongi! Jeong Hoseok! Park Jimin! Kim Taehyung! Jeon Jung kook! BTS!]]', chant: '', chantOnly: true },
      { t: 15, text: '[[Kim Namjoon! Kim Seokjin! Min Yoongi! Jeong Hoseok! Park Jimin! Kim Taehyung! Jeon Jung kook! BTS!]]', chant: '', chantOnly: true },
      ...
      { t: 77.5, text: 'How you think bout that {{(that)}}', chant: '' },
      { t: 79, text: 'How you think bout that {{(that)}}', chant: '' },
      { t: 80, text: 'Haterdeureun beolsseo hageul tte {{(hageul tte)}}', chant: '' },

      { t: 83.5, text: 'Imi hwanggeumbich hwanggeumbich naui seonggong {{(seonggong)}}', chant: '' },
      { t: 85.5, text: 'I\u2019m so firin\u2019 firin\u2019 seonghwabongsong {{(bongsong)}}', chant: '' },
      { t: 88.5, text: 'Neoneun hwanggeubhi hwanggeubhi domang syongsyong {{(syongsyong)}}', chant: '' },
      ...
      { t: 117.5, text: 'Igeo wanjeon ne geulja {{(ja)}}', chant: '' },
      { t: 118.5, text: 'Sapilgwijeong ah {{(ah)}}', chant: '' },
      { t: 120.5, text: 'Once upon a time', chant: '' },
      { t: 121.5, text: 'Isobuhwa fly', chant: '' },
      { t: 122.5, text: 'Ni hyeonsireul bwara [[ssae ssaemtong]]', chant: '' },
      { t: 125.5, text: 'Jigeum jugeodo nan gae[[haengbog]]', chant: '' },
      { t: 129.5, text: 'Ibeonen eoneu nara ga', chant: '' },
      { t: 132.5, text: 'Bihaenggi myeoch siganeul ta', chant: '' },
      { t: 134.5, text: 'Yeah I\u2019m on the mountain', chant: '' },
      { t: 135.5, text: 'Yeah I\u2019m on the bay', chant: '' },
      { t: 137, text: 'Mudaeeseo taljin', chant: '' },
      { t: 138.5, text: '[[MIC Drop baam]]', chant: '' },

      { t: 140, text: 'Did you see my bag {{(bag)}}', chant: '' },
      { t: 141, text: 'Did you see my bag {{(bag)}}', chant: '' },
      { t: 142.5, text: 'Teuropideullo baegi gadeughae {{(gadeughae)}}', chant: '' },
      ...
      { t: 171, text: '[[Bal bal]] josim', chant: '' },
      { t: 172, text: 'Neone [[mal mal]] josim', chant: '' },

      { t: 173, text: 'Lodi dodi a neomu bappa', chant: '' },
      { t: 176, text: 'Neomu busy nae onmomi mojalla', chant: '' },
      { t: 179, text: '[[MIC Drop]]', chant: '' },
      { t: 180.5, text: '[[MIC Drop]]', chant: '' },
      { t: 182.5, text: '[[Bal bal]] josim', chant: '' },
      { t: 183.5, text: 'Neone [[mal mal]] josim', chant: '' },

      { t: 187, text: 'Haters gon\u2019 hate', chant: '' },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { t: 52.5, text: 'When I wake up in my room {{(room)}}', chant: '' },
      { t: 55, text: 'Nan mwotdo eopji {{(mwotdo eopji)}}', chant: '' },
      ...
      { t: 76.5, text: 'Aesseuji jom mareo {{(mareo)}}', chant: '' },
      { t: 79, text: 'Jyeodo gwaenchana {{(gwaenchana)}}', chant: '' },

      { t: 81.5, text: 'Errbody say La la la la la {{(La la la la la)}}', chant: '' },
      { t: 84.5, text: 'Say La la la la la {{(La la la la la)}}', chant: '' },
      { t: 87, text: 'Soneul deureo sorijilleo Burn it up', chant: '' },

      { t: 91, text: 'Bultaoreune', chant: '' },

      { t: 92, text: '{{(BTS! BTS!)}} ayy-oh ayy-oh! Ssak da bultaewora [[Bow wow wow]]', chant: '' },
      { t: 101.7, text: '{{(BTS! BTS!)}} ayy-oh ayy-oh! Ssak da bultaewora [[Bow wow wow]]', chant: '' },

      { t: 111, text: 'Hey burn it up {{(burn it up)}}', chant: '' },
      { t: 113, text: 'Jeonbu da taeul geot gachi', chant: '' },
      { t: 115.7, text: 'Hey turn it up {{(turn it up)}}', chant: '' },
      { t: 117.7, text: 'Saebyeogi da gal ttaekkaji', chant: '' },
      { t: 120.7, text: 'Geunyang sarado dwae', chant: '' },
      { t: 121.7, text: '[[Urin jeolgie]]', chant: '' },
      { t: 123, text: 'Geu malhaneun neon', chant: '' },
      { t: 124, text: '[[Mwon sujeogillae]]', chant: '' },
      { t: 125.7, text: 'Sujeosujeo georyeo nan saraminde {{(hamseong)}}', chant: '' },
      { t: 127.7, text: 'So what', chant: '' },

      { t: 129.5, text: 'Ni meotdaero sareo {{(sareo)}}', chant: '' },
      { t: 131.5, text: 'Eochapi ni kkeoya {{(ni kkeoya)}}', chant: '' },
      ...
      { t: 144.5, text: 'Soneul deureo sorijilleo Burn it up', chant: '' },

      { t: 148.5, text: 'Bultaoreune', chant: '' },

      { t: 149.5, text: '{{(BTS! BTS!)}} ayy-oh ayy-oh! Ssak da bultaewora [[Bow wow wow]]', chant: '' },
      { t: 159, text: '{{(BTS! BTS!)}} ayy-oh ayy-oh! Ssak da bultaewora [[Bow wow wow]]', chant: '' },

      { t: 168.5, text: '[[Fire]] geop maneun jayeo yeogiro', chant: '' },
